/*
	this file contains to javascript code for our gallery
*/

var albums_template, photos_template, photo_template, slidewhow_template;
...
// a helper function that instantiates a template and displays
...
// document ready gets called when the whole document is loaded
// so we put most of the code that needs to run in here

$(document).ready(function() {
	// compile all of our templates to get them ready for use
	...
	slidewhow_template = Handlebars.compile(source);
