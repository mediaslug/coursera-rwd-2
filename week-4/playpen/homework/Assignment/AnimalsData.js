...
var animals_data = {
	category : [
		{
			name : "Reptiles",
			description: "A group (Reptilia) of tetrapod animals comprising today's turtles, crocodilians, snakes, lizards, tuatara, and their extinct relatives",
			animals : [
				{
		...
		{
			name : "Mammals",
			description: "Any members of a clade of endothermic amniotes distinguished from reptiles and birds by the possession of hair,[a] three middle ear bones, mammary glands, and a neocortex (a region of the brain). ",
		...
		{
			name : "Birds",
			description: "A group of endothermic vertebrates, characterised by feathers, a beak with no teeth, the laying of hard-shelled eggs, a high metabolic rate, a four-chambered heart, and a lightweight but strong skeleton.",
			animals : [
				{
